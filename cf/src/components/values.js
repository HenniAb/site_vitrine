                ...
                <Col xl={4} lg={4} md={4} sm={12}  xs={12} offset={{sm: 0, xs: 0, md: 0, xl: 0, lg: 0}}>
                    <Col style={{marginBottom: "40px"}}>
                        <Card style={{background: "linear-gradient(to right bottom, #EACB87, #E95C57)", border: "none"}}>
                            ...
                            <Img width="100%" src={"../img/team/photo3.jpg"} alt="Card image cap" />
                            <CardBody>
                    ...
                    <Col style={{marginBottom: "40px"}}>
                        <Card style={{background: "linear-gradient(to right top, #EACB87, #E95C57)", border: "none"}}>
                            ...
                            <Img width="100%" src={"../img/team/christelle.jpg"} alt="Card image cap" />
                            <CardBody>
                    ...
                    <Col style={{marginBottom: "40px"}}>
                        <Card style={{background: "linear-gradient(to left bottom, #EACB87, #E95C57)", border: "none"}}>
                            ...
                            <Img width="100%" src={"../img/team/leo.jpg"} alt="Card image cap" />
                            <CardBody>
                ...
                <Col xl={4} lg={4} md={4} sm={12}  xs={12} offset={{sm: 0, xs: 0, md: 0, xl: 0, lg: 0}}>
                    <Col style={{marginBottom: "40px"}}>
                        <Card style={{background: "linear-gradient(to right bottom, #EACB87, #E95C57)", border: "none"}}>
                            ...
                            <Img width="100%" src={"../img/team/hadrien.jpg"} alt="Card image cap" />
                            <CardBody>
                    ...
                    <Col style={{marginBottom: "40px"}}>
                        <Card style={{background: "linear-gradient(to right top, #EACB87, #E95C57)", border: "none"}}>
                            ...
                            <Img width="100%" src={"../img/team/remy.jpg"} alt="Card image cap" />
                            <CardBody>
                    ...
                    <Col style={{marginBottom: "40px"}}>
                        <Card style={{background: "linear-gradient(to left bottom, #EACB87, #E95C57)", border: "none"}}>
                            ...
                            <Img width="100%" src={"../img/team/fabien.jpg"} alt="Card image cap" />
                            <CardBody>
                ...
                <Col xl={4} lg={4} md={4} sm={12}  xs={12} offset={{sm: 0, xs: 0, md: 0, xl: 0, lg: 0}}>
                    <Col style={{marginBottom: "40px"}}>
                        <Card style={{background: "linear-gradient(to right bottom, #EACB87, #E95C57)", border: "none"}}>
                            ...
                            <Img width="100%" src={"../img/team/julien.jpg"} alt="Card image cap" />
                            <CardBody>
                    ...
                    <Col style={{marginBottom: "40px"}}>
                        <Card style={{background: "linear-gradient(to right top, #EACB87, #E95C57)", border: "none"}}>
                            ...
                            <Img width="100%" src={"../img/team/rocat.jpg"} alt="Card image cap" />
                            <CardBody>
