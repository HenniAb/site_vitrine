      ...
      <header>
        <Navbar color="faded" light expand="md" style={ colorBgNav }>
          <NavbarBrand href="/" width={ '190px' } style={ colorTextNav }>Centrale Fitness&nbsp;
            <img alt="logo_of_header" src={ logo } height={ '45px' } /></NavbarBrand>
